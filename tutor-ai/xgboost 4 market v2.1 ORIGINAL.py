# =================================================================================
# XGBoost Stock Prediction - v72.1 (ORIGINAL - CON BUG NEI CSV TRADE)
#
# DESCRIZIONE:
...
#
# NOTA: Questa versione contiene un BUG nella funzione calculate_trade_metrics
#       che genera CSV con trade duplicati (scenari alternativi invece di trade sequenziali).
#       Vedere righe 735-739 per il bug specifico.
# =================================================================================
...
# --- Setup ---
CACHE_DIR = "cache_v72.5_backtester"
os.makedirs(CACHE_DIR, exist_ok=True)
output_dir = f"run_v72.5_final_backtester_{datetime.today().strftime('%Y%m%d_%H%M%S')}"
